...
\item \begin{project}[https://cse.iitk.ac.in/users/rharish/ugp1]{Multi-Agent GANs for Image Super-Resolution}{Aug '18 - Dec '18}{Prof. Vinay Namboodiri}
    \item A \textit{Multi-agent generalisation} of \href{https://arxiv.org/abs/1609.04802}{\textit{SRGAN}} inspired by \href{http://openaccess.thecvf.com/content_cvpr_2018/papers_backup/Ghosh_Multi-Agent_Diverse_Generative_CVPR_2018_paper.pdf}{\textit{MADGANs}} for image super-resolution in \textit{TensorFlow}.
